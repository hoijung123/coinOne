...
<div id="wrap">
	...
	<div id="container">
		<!-- 좌측메뉴 시작 -->
		<div id="leftmenu"><jsp:include page="menu.jsp" flush="false" /></div>
		<!-- //좌측메뉴 끝 -->
	...
	<select name="currency" id="currency"
		...
		<option value="btc"
				<c:if test="${currency eq 'btc'}">selected</c:if> >btc</option>
		<option value="eth"
				<c:if test="${currency eq 'eth'}">selected</c:if> >eth</option>
		<option value="etc"
				<c:if test="${currency eq 'etc'}">selected</c:if> >etc</option>
		<option value="qtum"
				<c:if test="${currency eq 'qtum'}">selected</c:if> >qtum</option>
	</select> <br>
